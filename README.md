...
1. <a href="#event-dispatcher"><code>class <b>EventDispatcher</b></code></a>
    ...
    1. [`removeEventListener`](#remove-event-listener)
    1. [`dispatchEvent`](#dispatch-event)
    1. [`transaction`](#transaction)
1. <a href="#event"><code>class <b>Event</b></code></a>
    1. [`target`](#target)
    1. [`relatedTarget`](#related-target)
    1. [`stopPropagation`](#stop-propagation)
    1. [`isPropagationStopped`](#is-propagation-stopped)
    1. [Catalog of built-in events](#catalog-of-built-in-events)
        ...
        1. [<a href="#event"><code>class <b>ChangeEvent</b> extends MutationEvent</code></a>](#change-event)
            1. [`key`](#key)
        1. [<a href="#event"><code>class <b>AddEvent</b> extends MutationEvent</code></a>](#add-event)
            1. [`model`](#add-event_model)
        1. [<a href="#event"><code>class <b>RemoveEvent</b> extends MutationEvent</code></a>](#remove-event)
            1. [`model`](#remove-event_model)
        1. [<a href="#event"><code>class <b>SortEvent</b> extends MutationEvent</code></a>](#remove-event)
            1. [`model`](#sort-event_model)
            1. [`previousIndex`](#previous-index)
1. <a href="#model"><code>class <b>Model</b> extends EventDispatcher</code></a>
    1. [`Model.attributesKey`](#model.attributes-key)
    1. [`new Model`](#model.constructor)
    1. [`attributes`](#attributes)
    1. [`getUniqueId`](#model_get-unique-id)
    1. [`getId`](#get-id)
    1. [`update`](#model_update)
1. <a href="#descriptor"><code>interface <b>Descriptor</b></code></a>
    1. [`get`](#descriptor_get)
    1. [`set`](#descriptor_set)
    1. [`default`](#default)
    1. [`serializable`](#serializable)
    1. [`constant`](#constant)
    1. [`required`](#required)
1. <a href="#list"><code>class <b>List</b></code></a>
    1. [`List.of`](#list.of)
    1. [`new List`](#list.constructor)
    1. [`[]`](#list_brackets)
    1. [`length`](#length)
    1. [`valueOf`](#list_value-of)
    1. [`update`](#list_update)
1. <a href="#chainable-descriptor"><code>class <b>ChainableDescriptor</b> implements Descriptor</code></a>
    1. [`new ChainableDescriptor`](#chainable-descriptor.constructor)
    1. [`then`](#then)
    1. [`assert`](#assert)
    1. [`process`](#process)
    1. [`construct`](#construct)
    1. [`isRequired`](#is-required)
    1. [`defaultValue`](#default-value)
    1. [`notSerializable`](#not-serializable)
    1. [`propagate`](#propagate)
    1. [`nested`](#nested)
    1. [Creating custom `ChainableDescriptor`](#creating-custom-chainable-descriptor)
